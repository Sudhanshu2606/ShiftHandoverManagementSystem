        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HandoverReports_Users_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Issues_HandoverReports_HandoverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_HandoverReports_HandoverId",
                        column: x => x.HandoverId,
                        principalTable: "HandoverReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HandoverReports_CreatorId",
                table: "HandoverReports",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Issues_HandoverId",
                table: "Issues",
                column: "HandoverId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_HandoverId",
                table: "Tasks",
                column: "HandoverId");
        }
